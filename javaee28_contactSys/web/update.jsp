...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/UpdateContactServlet?id=${contact.id}" method="post">
        ...
        <div class="form-group">
            ...
            <script type="text/javascript">
                $("input[name=sex][value=${contact.sex}]").prop("checked", "checked");
            </script>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="address" class="form-control">
                ...
                <script type="text/javascript">
                    $("option[value=${contact.address}]").prop("selected", "selected");
                </script>
            </select>
        </div>
